...
<!--
  <div>
    <input v-model="collectionName" placeholder="Collection Name" type="text" class="mx-2 border border-gray-300 ml-4 px-8 py-1 rounded-xl focus:placeholder-transparent dark:focus:placeholder-transparent dark:placeholder-gray-400 placeholder-gray-400 bg-white dark:bg-cyan-800 text-gray-800 dark:text-gray-100"/>
    <create-button text="Create collection" @click="createCollection" />
  </div>
-->
