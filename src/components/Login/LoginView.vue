      ...
      <div class="container py-12 px-6 h-full">
        <div class="flex justify-center items-center flex-wrap h-full g-6 dark:text-gray-200 text-gray-800">
          <div class="xl:w-10/12">
            <div class="block dark:bg-cyan-800 bg-cyan-100 shadow-lg rounded-lg">
              <div class="lg:flex lg:flex-wrap g-0">
                <div v-if="!showForgot" class="lg:w-6/12 px-4 md:px-0">
                  <div class="md:p-12 md:mx-6">
                    ...
                    <form @submit.prevent="login">
                      <div class="relative">
                          <input required v-model="username" type="text" id="name"
                      ...
                      <div class="relative mt-4">
                          <input required v-model="password" type="password" id="label"
                          class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white dark:border-cyan-800 border-cyan-100 dark:bg-gray-800 rounded-lg border-2 appearance-none dark:text-white dark:focus:border-cyan-300 focus:outline-none focus:ring-0 focus:border-cyan-300 peer" placeholder=" " />
                      ...
                      <div class="text-center pt-4 mb-6 pb-1">
                        <login-button type="submit" text="Login" class="px-4"/>
                      </div>
                    </form>
                    <div v-if="errorMessage" class="pb-6 dark:text-orange-600 text-red-600">
                      <i class="fa-solid fa-circle-exclamation">&nbsp;</i>{{ errorMessage }}
                    </div>
                    <div v-else class="pb-6">
                      &nbsp;
                    </div>
                    <div class="pb-6 dark:text-gray-200 text-gray-800 cursor-pointer" @click="forgotPassword">
                      Forgot password?
                    </div>
                  </div>
                </div>
                <div v-else class="lg:w-6/12 px-4 md:px-0">
                  <div class="md:p-12 md:mx-6">
                    <div class="text-center">
                      <img class="mx-auto w-24 logo" alt="Vue logo" src="@/assets/logo.svg" width="25"/>
                    ...
                    <form @submit.prevent="resetPassword">
                      ...
                      <div class="text-center pt-4 mb-6 pb-1">
                        <cancel-button @click="cancelResetPassword" class="mx-4"/>
                        <email-button type="submit" text="Reset Password" class="px-4"/>
                      </div>
                    </form>
                  </div>
                </div>
...
<script setup lang="ts">
    ...
    const resetPassword = () => {
      console.log('resetPassword > E-mail : ', email.value);
    };
